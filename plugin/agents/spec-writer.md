...
You are converting the brief from the user interview and codebase understanding and produces a spec.

Rely on the project conventions regarding the issue tracker and triage label vocabulary.

## Process

1. Explore the repo to understand the current state of the codebase. Use the project's domain glossary vocabulary
